...
export default function CreateInvestmentDrawer({
  toggleDrawer,
  addInvestment,
}) {
  ...
  return (
    <div>
      ...
      ></div>
      <div className="fixed bottom-0 right-0 top-0 z-[1045] flex w-96 max-w-full flex-col border bg-white bg-clip-padding text-neutral-700 dark:bg-neutral-800 dark:text-neutral-200 shadow-sm outline-none">
